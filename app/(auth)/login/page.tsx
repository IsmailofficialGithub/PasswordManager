...
function LoginForm() {
  ...
  const handleEmailLogin = async (e: React.FormEvent) => {
    ...
    try {
      // Use server-side login API to ensure cookies are set properly
      ...
      // Verify session is actually established on the client
      ...
      window.location.href = data.redirectTo || "/master-password";
    } catch (err: any) {
    ...
    <div className="flex min-h-screen items-center justify-center bg-background p-4">
      <Card className="w-full max-w-md">
        <CardHeader>
          ...
          <CardDescription>
            Sign in to access your credential vault
          </CardDescription>
        </CardHeader>
        <CardContent>
